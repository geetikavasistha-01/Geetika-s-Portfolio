  ...
  return (
    <PageWrapper>
      ...
      <div className="w-full mb-5">
        <div className="relative overflow-hidden rounded-[24px] border border-border/80 bg-surface/50 px-8 py-7 shadow-sm flex flex-col sm:flex-row sm:items-center justify-between gap-5">
          <div className="absolute -right-24 -top-24 w-56 h-56 rounded-full bg-teal/5 blur-3xl pointer-events-none" />
          <div className="absolute -left-24 -bottom-24 w-56 h-56 rounded-full bg-teal/5 blur-3xl pointer-events-none" />
